...
```{r}
data.list <- list(AML2 = readRDS("./results/separated/AML2_CD34pos/AML2_CD34pos.rds"),
                  AM9 = readRDS("./results/separated/AML9_CD34pos/AML9_CD34pos.rds"),
                  AML14 = readRDS("./results/separated/AML14_CD34pos/AML14_CD34pos.rds"))

for (i in 1:length(data.list)){
  if( i < 4){
    data.list[[i]]$condition = "t(8;21)"
  } else {
...
plotlist
 ...
 ## Selected
 aml.combined@meta.data$newcluster <- listcluster[["0.5"]] #0.4
...
# Export
```{r}
exportdir <- "./results/integrated/t(8;21)_Dx/"
dir.create("./results/integrated")
dir.create(exportdir)
saveRDS(aml.combined, paste0(exportdir, "t(8;21)_Dx.rds"))
...
#transv <- aml.combined$condition == "t(8;21)"
