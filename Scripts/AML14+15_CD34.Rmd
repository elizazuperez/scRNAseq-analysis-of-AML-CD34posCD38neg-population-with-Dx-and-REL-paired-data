...
```{r}
Dx <- readRDS("./results/separated/AML14_CD34pos/AML14_CD34pos.rds")
Dx@meta.data$orig.ident <- rep("Dx",nrow(Dx@meta.data))
REL <- readRDS("./results/separated/AML15_CD34pos/AML15_CD34pos.rds")
...
```{r}
library(kableExtra)
exportdir <- "./results/integrated/AML14.15_CD34/"
...
dir.create("./results/integrated")
dir.create(exportdir)
saveRDS(aml.combined, paste0(exportdir, "AML14.15_integrated.rds"))
