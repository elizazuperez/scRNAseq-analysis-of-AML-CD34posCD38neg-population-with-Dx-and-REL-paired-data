...
plot2 +  geom_hline(yintercept=c(1500,5500)) + geom_vline(xintercept = 35000)
plot1  + geom_vline(xintercept = 35000) + geom_hline(yintercept = 20)
datapre <- subset(datapre, subset = nFeature_RNA > 1500 & nFeature_RNA < 5500 & percent.mt < 20 & nCount_RNA <35000 & nCount_RNA > 2000)
...
datapre <- AddMetaData(object = datapre, metadata = factor(celltypes), col.name = "projections")
 ...
 datapre@meta.data$newcluster <- listcluster[["1"]] #2, 1
