...
plot2 +  geom_hline(yintercept=c(800,5500)) + geom_vline(xintercept = 22000)
plot1  + geom_vline(xintercept = c(2000,25000)) +  geom_hline(yintercept=c(20))
datapre <- subset(datapre, subset = nFeature_RNA > 2000 & nFeature_RNA < 5500 & percent.mt < 20 & nCount_RNA <22000 & nCount_RNA > 2000)
...
DimHeatmap(datapre, dims = 1:21, cells = 500, balanced = TRUE) 
print(x = datapre[["pca"]], 
      dims = 1:21, 
      nfeatures = 5)
...
datapre <- FindClusters(datapre, verbose = FALSE, resolution = 0.6) #varios clusters con diferentes resoluciones para compararlos 
