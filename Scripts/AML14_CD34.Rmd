...
plot2 +  geom_hline(yintercept=c(800,5500)) + geom_vline(xintercept = 40000)
plot1  + geom_vline(xintercept = 40000)
datapre <- subset(datapre, subset = nFeature_RNA > 800 & nFeature_RNA < 5500 & percent.mt < 20 & nCount_RNA <40000)
