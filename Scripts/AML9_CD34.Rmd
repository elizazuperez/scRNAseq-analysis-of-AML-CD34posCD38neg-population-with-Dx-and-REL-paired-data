...
plot2 +  geom_hline(yintercept=c(200,5000)) + geom_vline(xintercept = 30000)
plot1  + geom_vline(xintercept = 30000)
datapre <- subset(datapre, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 & percent.mt < 20 & nCount_RNA <30000)
